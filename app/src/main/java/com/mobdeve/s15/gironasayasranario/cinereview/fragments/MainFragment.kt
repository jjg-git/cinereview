...
import com.mobdeve.s15.gironasayasranario.cinereview.DataGenerator
import com.mobdeve.s15.gironasayasranario.cinereview.MovieAdapter
...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        movieRecycler = view.findViewById(R.id.movieRv)

        this.data = DataGenerator.generateData()
        movieRecycler.adapter = MovieAdapter(data, findNavController())
